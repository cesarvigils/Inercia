...
/* =========================================================
   INJECT AUTH MODAL + PROFILE MENU (if not already on page)

   Any page that loads auth.js now gets a working modal
   automatically — no need to hand-copy the modal HTML into
   every page (that mismatch was the original bug).
   ========================================================= */
